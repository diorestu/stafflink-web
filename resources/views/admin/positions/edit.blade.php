    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="px-8 py-6 border-b bg-gray-50/60 rounded-t-xl">
                ...
                <p class="text-sm text-gray-500 mt-1">Update division and position details.</p>
            </div>
            <form action="{{ route('admin.positions.update', $position) }}" method="POST" class="p-8 space-y-8">
                @csrf
                @method('PUT')
