    ...
    <div class="max-w-4xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="px-8 py-6 border-b bg-gray-50/60 rounded-t-xl">
                <h3 class="text-lg font-semibold text-gray-900">Create Career</h3>
                <p class="text-sm text-gray-500 mt-1">This career will be shown inside category popup cards.</p>
            </div>
