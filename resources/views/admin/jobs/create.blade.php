...
@section('page-title', 'Add Career Post')

@section('content')
    <div class="max-w-5xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="px-8 py-6 border-b bg-gray-50/60 rounded-t-xl">
                <h3 class="text-lg font-semibold text-gray-900">Create Career Post</h3>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <select name="work_mode" id="work_mode" required
                                ...
                                <option value="hybrid" {{ old('work_mode', 'hybrid') === 'hybrid' ? 'selected' : '' }}>Hybrid</option>
                            </select>
                            @error('work_mode')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="border border-gray-100 rounded-lg p-4 bg-gray-50">
                        <div class="space-y-3">
                            ...
                            <label class="mt-2 inline-flex items-center gap-2 text-sm text-gray-700">
                                <input type="checkbox" name="hide_salary_range" value="1" @checked(old('hide_salary_range'))
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        <div>
                            ...
                            <textarea name="custom_questions_text" id="custom_questions_text" rows="4"
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#287854] focus:border-transparent"
                                placeholder="Why are you a great fit for this role?&#10;What is your expected start date?">{{ old('custom_questions_text') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="whatsapp_inquiry_template" id="whatsapp_inquiry_template" rows="3"
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#287854] focus:border-transparent"
                                placeholder="Hi Staff Link, I want to ask about the {position} role in {location}.">{{ old('whatsapp_inquiry_template') }}</textarea>
