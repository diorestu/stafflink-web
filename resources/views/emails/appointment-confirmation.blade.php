                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:680px; background:#ffffff; border:1px solid #d8e4de; border-radius:14px; overflow:hidden;">
                    <tr>
                        <td style="background:#ffffff; border-top:6px solid #1f5f46; border-bottom:1px solid #e8efeb; padding:24px 24px 20px; text-align:center;">
                            ...
                            <p style="margin:0; font-size:12px; letter-spacing:1.6px; text-transform:uppercase; color:#8b6d1a;">Appointment Request</p>
                            <h1 style="margin:10px 0 0; font-size:24px; line-height:1.3; color:#1f5f46;">Confirmation Received</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:24px;">
                            ...
                            <p style="margin:0 0 16px; font-size:14px; color:#3f4b45;">
                                Thank you for booking a consultation with {{ config('app.name') }}. Your request has been received and is currently pending review.
                            </p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 18px; border:1px solid #d8e4de; border-radius:10px; overflow:hidden;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:10px 14px; font-size:14px; font-weight:600; color:#173f31; border-top:1px solid #e8efeb;">Pending Approval</td>
                                </tr>
                            </table>

                            <p style="margin:0 0 8px; font-size:13px; color:#3f4b45;">
                                Contact detail on request:
                                <strong>{{ $appointment->email }}</strong> | <strong>{{ $appointment->phone }}</strong>
                            </p>
                            <p style="margin:0; font-size:13px; color:#3f4b45;">
                                If you need to update this request, please reply to this email.
                            </p>
                        </td>
                    </tr>
                    <tr>
