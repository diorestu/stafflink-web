...
<head>
    ...
    @include('partials.seo-meta', [
        'seoTitle' => \App\Models\SiteSetting::siteName().' | What We Offer',
        'seoDescription' => 'Explore StaffLink staffing, recruitment, and outsourcing services designed to help your business scale with confidence.',
        'seoKeywords' => 'staffing services, recruitment services, outsourcing bali, talent solutions',
    ])
                ...
                <div class="overflow-hidden rounded-[32px] bg-[#dceae3] shadow-[0_20px_60px_rgba(31,95,70,0.16)]" data-aos="fade-up">
                    <div class="grid gap-12 p-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:p-14">
                        ...
                        <div class="flex items-end justify-center lg:justify-end">
                            <img src="{{ asset('images/single_img.webp') }}" alt="StaffLink Team"
                                class="h-80 w-auto rounded-3xl bg-white/40 object-cover p-2 shadow-[0_10px_30px_rgba(31,95,70,0.2)]" draggable="false" loading="lazy" />
                        </div>
                    </div>
                </div>
