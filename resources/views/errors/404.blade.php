...
<head>
    ...
    @include('partials.seo-meta', [
        'seoTitle' => '404 - Page Not Found | '.\App\Models\SiteSetting::siteName(),
    ...
    <main class="card">
        ...
        <section class="body">
            ...
            <p>
                ...
                Try navigating from the homepage or use the contact page if you need help.
            </p>
            <div class="actions">
                <a class="btn btn-primary" href="{{ url('/') }}">Back to Homepage</a>
                <a class="btn btn-secondary" href="{{ url('/contact') }}">Go to Contact</a>
            </div>
        </section>
